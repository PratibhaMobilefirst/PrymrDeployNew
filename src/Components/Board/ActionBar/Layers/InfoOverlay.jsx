...
const InfoOverlay = () => {
  ...
  const [selectedForCommentOption, setSelectedForCommentOption] =
    useState(null);
  ...
  return (
    <>
      <div className="flex justify-center   flex-col h-screen overflow-hidden">
        <div className=" ">
          {layers?.map((layer) => (
            <div
              key={layer.id}
        ...
        <div className="container  text-white flex-grow">
          <div className="relative ">
            ...
            <div className="">
              <div className="relative top-1/3 m-1 justify-center  flex gap-2 md:gap-10">
                <div className="flex gap-3 p-2 pl-2  pr-2 border-2 rounded-full">
                  <div className=" text-xs w-[45px] mt-[10px]"> For Sale</div>
                  <img src={Line68} className="h-6 " />
                ...
                <div>
                  {" "}
                  <input
                    className="bg-[#191919] border-b-2 mt-5 w-auto md:pl-2"
