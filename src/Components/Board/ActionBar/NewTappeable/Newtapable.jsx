...
//   return (
//     <div className="px-1 -py-5 text-white bg-gray-800 bg-opacity-75 justify-center">
//       <div className="flex scroll-pt-20">
//         <img
//           src={cross}
//           alt="X"
...
//       <div
//         className="flex px-8 m-4 gap-1 items-center py-2 rounded-[20px] border-[1px] p-[10px_15px_10px_15px] cursor-pointer"
