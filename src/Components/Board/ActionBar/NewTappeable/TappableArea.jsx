  ...
  useEffect(() => {
    const handleMouseMove = (e) => {
      if (isDragging) {
        ...
        newX = Math.max(
          0,
          Math.min(newX, imageBounds.width - tappableRef.current.offsetWidth)
        );
        newY = Math.max(
          0,
          Math.min(newY, imageBounds.height - tappableRef.current.offsetHeight)
        );
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="absolute bottom-0 right-0 bg-white p-1 cursor-se-resize"
